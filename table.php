...
<div class="container card mt-2">
    <div class="card-header mt-2">
        <div class="text-center">
            <h2 class="text-start">STUDENT INFORMATION
    ...
    <table class="container table mt-2">
        ...
        foreach ($rst as $CX) {?>
            <tr>
                ...
                <th scope="row"><?php echo $CX['student_id'];?></th>
                ...
                <td><?php echo $CX['phone_number'];?></td>
                <td><?php echo $CX['statuss'];?></td>
                <td><?php echo $CX['birthday'];?></td>
                
                <td>
    <a href="edit.php?student_id=<?php echo $CX['student_id']; ?>" class="btn btn-success btn-sm">Edit</a>
    <a href="delete.php?student_id=<?php echo $CX['student_id']; ?>" class="btn btn-danger btn-sm">Delete</a>
</td>
...
<div class="modal fade" id="mdlAddProduct" tabindex="-1" aria-labelledby="mdlAddProductLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form id="frmAddProduct" method="POST" action="table2.php">
            <div class="modal-content">
                <div class="modal-header bg-info text-white">
                    <h5 class="modal-title" id="mdlAddProductLabel">Add Student Information</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" name="btb_submit">Save changes</button>
                </div>
            </div>
        </form>
    </div>
